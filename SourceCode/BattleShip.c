 ...
 * Battleship
 *
 * Authors: Hunter Goforth, Erin Long, Sean Happenny, Vishesh Sood, Justin Allmaras, David Suh
 * Date: 3/6/16
 *
...
#define data (char*) 0x21100
#define address (char*) 0x21110
#define chipSelect (char*) 0x21120
#define readnWrite (char*) 0x21130
#define notOutEn (char*) 0x21140

// Communications System (Processor Inputs and Outputs)
#define char_read (char*) 0x21150
#define char_recv (char*) 0x21160
#define data_in (char*) 0x21170
#define load (char*) 0x21180
#define char_sent (char*) 0x21190
#define trans_en (char*) 0x211a0
#define data_out (char*) 0x211b0
#define LEDs (char*) 0x211c0
